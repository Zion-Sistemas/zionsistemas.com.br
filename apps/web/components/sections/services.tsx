...
export function ServicesSection() {
  return (
    <section id="servicos" className="bg-[#f2f4f6] px-8 sm:px-12 py-20 lg:py-32">
          ...
          <Card className="relative col-span-full flex overflow-hidden border-0 bg-white lg:col-span-2">
            <CardContent className="relative m-auto size-fit pt-6 text-center">
              <div className="relative flex h-24 w-56 items-center justify-center">
                <svg
                  className="absolute inset-0 size-full text-[#eceef0]"
                  viewBox="0 0 254 104"
                  fill="none"
                ...
                <span className="relative mx-auto block w-fit font-[family-name:var(--font-display)] text-5xl font-black text-[#0049db]">
                  100%
                </span>
              </div>
              <h3 className="mt-6 text-center font-[family-name:var(--font-display)] text-2xl font-bold text-[#191c1e]">
                Personalizado
              </h3>
              <p className="mx-auto mt-2 max-w-[180px] text-sm leading-relaxed text-[#191c1e]/60">
            ...
            <CardContent className="pt-6">
              <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-[#c3c5d8]/40 before:absolute before:-inset-2 before:rounded-full before:border before:border-[#c3c5d8]/20">
                ...
                >
                  ...
                  />
                  {/* Gradient overlay — top arc fades to Electric Blue */}
              ...
              <div className="mt-6 space-y-2 text-center">
                ...
                <p className="text-sm leading-relaxed text-[#191c1e]/60">
                  Elimine tarefas repetitivas e reduza erros com automações
                  inteligentes.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent className="grid pt-6 sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm leading-relaxed text-[#191c1e]/60">
                    Desenvolvimento de plataformas personalizadas para atender
                    exatamente às necessidades do seu negócio.
                  </p>
                </div>
              </div>
              <div className="relative mt-6 -mr-6 -mb-6 h-fit rounded-tl-lg border-t border-l border-[#c3c5d8]/30 p-6">
                ...
                <div className="mt-4 space-y-2 font-mono text-xs text-[#191c1e]/30">
                  {[
                    {
                      text: "function buildSystem(needs) {",
                      color: "text-[#0049db]/70",
                    },
                    ...
                    <div
                      key={i}
                      className={`${line.color || "text-[#191c1e]/30"}`}
                    >
                      {line.text || "\u00A0"}
                    </div>
                  ))}
            ...
            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm leading-relaxed text-[#191c1e]/60">
                    Conectamos diferentes sistemas para centralizar e otimizar
                    sua operação.
                  </p>
                </div>
              </div>
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-[#c3c5d8]/30 sm:-my-6 sm:-mr-6">
                <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                  <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                    <span className="block h-fit rounded border border-[#c3c5d8]/40 bg-[#f2f4f6] px-2 py-1 text-xs text-[#191c1e]/60">
                      CRM
                    </span>
                    <div className="flex size-7 items-center justify-center rounded-full bg-[#0049db]/10 ring-4 ring-white">
                      <ShieldCheckIcon className="size-3.5 text-[#0049db]" />
                    </div>
                  </div>
                  <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                    <div className="flex size-8 items-center justify-center rounded-full bg-[#0049db] ring-4 ring-white">
