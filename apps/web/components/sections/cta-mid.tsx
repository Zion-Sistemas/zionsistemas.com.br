  ...
  return (
    <section className="py-32 px-6 bg-white">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          <h2
            className="text-3xl md:text-5xl font-black text-[#0d1c32] font-[family-name:var(--font-display)]"
          ...
          <Link
            ...
            className="group inline-flex items-center gap-3 bg-[#0d1c32] text-white pl-6 pr-2 py-2 rounded-full font-semibold text-sm hover:scale-105 active:scale-95 transition-transform duration-200"
          >
            {ctaMid.cta.label}
